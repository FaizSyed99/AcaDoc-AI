...
describe('AppSidebar', () => {
  it('renders correctly when expanded', () => {
    ...
    expect(screen.getByText(/AcaDoc AI/i)).toBeDefined()
    
    // Check for navigation items (using actual locale values)
    expect(screen.getByText(/Medical References/i)).toBeDefined()
    expect(screen.getByText(/Study-Sets/i)).toBeDefined()
  })
  ...
  it('shows collapsed view when isCollapsed is true', () => {
    ...
    expect(screen.queryByText(/AcaDoc AI/i)).toBeNull()
  })
})
