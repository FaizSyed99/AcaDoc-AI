export const enUS = {
  common: {
    ...
    note: "Note",
    insight: "Insight",
    newSource: "New Medical Reference",
    newNotebook: "New Study-Set",
  ...
  navigation: {
    ...
    notebooks: "Study-Sets",
    askAndSearch: "Medical AI",
    podcasts: "Podcasts",
    models: "Models",
  ...
  chat: {
    ...
    startByCreating: "Start by ingesting your first Medical Reference to generate Clinical Insights.",
